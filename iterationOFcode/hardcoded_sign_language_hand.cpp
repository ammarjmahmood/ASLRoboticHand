...
// # Option 1: Call the program directly
// import subprocess
// def display_letter(letter):
//     subprocess.run(['./sign_language_hand', letter])

// # Option 2: Use ctypes to call the C++ code directly as a library
// from ctypes import cdll
// hand_lib = cdll.LoadLibrary('./libsignlanguagehand.so')
